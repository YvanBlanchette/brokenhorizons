...
const variants = {
  primary: clsx(
    ...
    'rounded-full border border-transparent bg-white/40 shadow-md',
    'text-base font-medium tracking-wider whitespace-nowrap text-white',
    'transition data-disabled:bg-gray-950 data-disabled:opacity-30 data-hover:bg-white/30',
  ),
  secondary: clsx(
    'relative inline-flex items-center justify-center px-4 py-[calc(--spacing(2)-1px)]',
    'rounded-full border border-transparent bg-gray-200/15 shadow-md ring-1 ring-[#D15052]/15',
